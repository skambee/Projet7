...
function renderSelectedFilters() {
    ...
    // Crée un élément pour chaque filtre.
...
function updateSelectedItemLayout(selectedElement) {
    ...
    // Ajoute l'icône de fermeture si elle n'existe pas.
...
function createCloseSvg(forDropdown) {
    ...
    if (forDropdown) {
        ...
        // Crée l'icône utilisée dans la liste des filtres.
